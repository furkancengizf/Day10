package kodlamaio.northwind.Businesss.Constans;
...
public class Messages {
    ...
    public static String SchoolAdded = "School Added";
    ...
    public static String SocialNetworkAdded = "Social Network Added";
